...
func (d *Database) Init(context context.Context) error {
	...
	CREATE TABLE IF NOT EXISTS ads(advert_id INT NOT NULL, content BLOB NOT NULL, rating INT NOT NULL, seen INT, rated INT, description TEXT); CREATE UNIQUE INDEX IF NOT EXISTS idx_id ON ads (advert_id);`
